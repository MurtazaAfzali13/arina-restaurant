...
export default async function GalleryPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-orange-50 to-white py-12 px-6 flex flex-col items-center pt-30">
      <h1 className="text-4xl font-bold text-gray-800 mb-6 text-center">
        🍴 Delicious Food Gallery
      </h1>
      <p className="text-gray-500 mb-10 max-w-2xl text-center">
