...
export default function ManageBranches() {
  ...
  // حل مشکل hydration با استفاده از conditional rendering
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-gray-500">{branch.slug || "no-slug"}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{branch.location || "No location"}</div>
                    </td>
